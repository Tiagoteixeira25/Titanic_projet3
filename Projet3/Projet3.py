...
def NouvelleFenetre():
    ...
    case_theme5_option1.place(x=50,y=540)
    case_theme5_option2.place(x=50,y=580)
    case_theme5_option3.place(x=50,y=620)
    


    button_rechercher.place(x=400,y=540)
...
canvas_pour_image = Canvas(window,width=2800,height=1500, bg='white',bd=0,highlightthickness=0)
